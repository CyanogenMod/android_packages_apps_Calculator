...
public class CalculatorExpressionTokenizer {
    ...
    public CalculatorExpressionTokenizer(Context context) {
        ...
        mReplacementMap.put("0", context.getString(R.string.digit0));
        mReplacementMap.put("1", context.getString(R.string.digit1));
        mReplacementMap.put("2", context.getString(R.string.digit2));
        mReplacementMap.put("3", context.getString(R.string.digit3));
        mReplacementMap.put("4", context.getString(R.string.digit4));
        mReplacementMap.put("5", context.getString(R.string.digit5));
        mReplacementMap.put("6", context.getString(R.string.digit6));
        mReplacementMap.put("7", context.getString(R.string.digit7));
        mReplacementMap.put("8", context.getString(R.string.digit8));
        mReplacementMap.put("9", context.getString(R.string.digit9));
