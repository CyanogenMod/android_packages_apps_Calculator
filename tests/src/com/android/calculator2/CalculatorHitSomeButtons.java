...
public class CalculatorHitSomeButtons extends ActivityInstrumentationTestCase2<Calculator> {
    ...
    private View getView(int id) {
        ...
        if(pager != null) {
            ...
            View v = ((CalculatorPageAdapter) pager.getAdapter()).getViewAtDontDetach(pager.getCurrentItem()).findViewById(id);
            if(v != null) {
                return v;
            }
        }
        // Tablet
            ...
            View v = ((CalculatorPageAdapter) smallPager.getAdapter()).getViewAtDontDetach(smallPager.getCurrentItem()).findViewById(id);
            if(v != null) {
                return v;
            }
            v = ((CalculatorPageAdapter) largePager.getAdapter()).getViewAtDontDetach(largePager.getCurrentItem()).findViewById(id);
            if(v != null) {
                return v;
            }
        }
