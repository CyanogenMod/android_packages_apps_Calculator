...
public class Page {
    ...
    public enum NormalPanel implements Panel {
        ...
        @Override
        public void refresh(Context context, final View view, EventListener listener, Graph graph,
                Logic logic) {
            if(NormalPanel.GRAPH.equals(this)) {
                if(!mGraphHolder.containsKey(view)) {
                    ...
                    l.addView(graphDisplay, new LayoutParams(LayoutParams.MATCH_PARENT,
