...
public abstract class AppDataSource implements DataSource {
    ...
    public String[] getColumns() {
        String[] allColumns = { StoreHelper.COLUMN_ID, StoreHelper.COLUMN_NAME,
                StoreHelper.COLUMN_PACKAGE, StoreHelper.COLUMN_PRICE, StoreHelper.COLUMN_IMAGE_URL };
        return allColumns;
    }
    ...
    public void deleteApp(App app) {
        ...
        database.delete(getTableName(), StoreHelper.COLUMN_PACKAGE + " = " + app.getPackageName(),
                null);
    }
