...
public class CalculatorWidget extends AppWidgetProvider {
    ...
    /*
    Add a decimal symboal at the end of input string as long as there is no decimal symboal
    ...
    */
    ...
    private static String addDecimal(String equation) {
        ...
        if (equation != null) {
            ...
            /* index would be less than zero either when input string is empty or index reached beginning
               of the string in previous loop
               foundOperator would be true when an operator was found while traversing the string   */
