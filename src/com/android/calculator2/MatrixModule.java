...
public class MatrixModule {
    ...
    // that Java does not have. In short, Java is not F#.
    private String calculate(String input) throws SyntaxException {
        ...
        match = Pattern.compile(
                "(\u221a|cbrt|log|ln|asin|acos|atan|sind|cosd|tand|asind|acosd|atand|sin|cos|tan|det)(\u2212?\\d+(?:\\.\\d+)?|\\[\\[.+\\]\\])")
                .matcher(input);
        while (match.find()) {
    ...
    String evaluateMatrices(AdvancedDisplay display) throws SyntaxException {
        ...
        return mLogic.getBaseModule().updateTextToNewMode(result, Mode.DECIMAL,
                mLogic.getBaseModule().getMode());
    }
    ...
    private String applyFunc(String func, String arg) throws SyntaxException {
        ...
        if (func.equals("\u221a")) {
            ...
            if (arg.startsWith("[[")) {
                ...
                // Determinant of a scalar is equivalent to det.
