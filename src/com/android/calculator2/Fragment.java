...
public abstract class Fragment extends android.support.v4.app.Fragment {
	...
	/**
	 * Returns a base context. This context will die when the activity dies, so don't hold on to it.
	 * */
	...
	/**
	 * Control whether the view is being displayed. You can make it not displayed if you are waiting
	 * for the initial data to show in it. During this time an indeterminant progress indicator will
	 * be shown instead.
	 * 
	 * @param shown
	 *			If true, the view is shown; if false, the progress indicator. The initial value is
	 *			true.
	 */
	...
	/**
	 * Like {@link #setViewShown(boolean)}, but no animation is used when transitioning from the
	 * previous state.
	 */
