...
public abstract class BitmapAdapter<T extends Serializable> extends ArrayAdapter<T> {
    ...
    /**
     * Passes the view from inflateView. There's a chance views like TextViews already have data, so
     * make sure to clear everything you aren't updating. Also, avoid permanent UI changes like
     * adding or removing views to convertView.
     */
