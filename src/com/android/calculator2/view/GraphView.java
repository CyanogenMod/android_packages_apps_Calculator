...
public class GraphView extends View {
    ...
    private void setup() {
        mMagicNumber = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources()
                .getDisplayMetrics());
        ...
        mTextPaint.setTextSize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            if(mMode == DRAG) {
                ...
                double distance = getDistance(new Point(event.getX(0), event.getY(0)), new Point(
    ...
    public void zoomReset() {
        setZoomLevel(1);
        mLineMargin = mMinLineMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
