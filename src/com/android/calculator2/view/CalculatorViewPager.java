...
public class CalculatorViewPager extends ViewPager {
    ...
    /**
     * ViewPager inherits ViewGroup's default behavior of delayed clicks on its children, but in
     * order to make the calc buttons more responsive we disable that here.
     */
    @Override
