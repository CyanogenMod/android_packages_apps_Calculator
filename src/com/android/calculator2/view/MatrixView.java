...
public class MatrixView extends TableLayout {
    ...
    public static boolean load(final MutableString text, final AdvancedDisplay parent, final int pos) {
        ...
        int columns = MatrixView.countOccurrences(matrix,
                getSeparator(parent.getContext()).charAt(0))
                / rows + 1;
    ...
    public void addRow() {
        ...
        tr.setLayoutParams(new MatrixView.LayoutParams(MatrixView.LayoutParams.WRAP_CONTENT,
                MatrixView.LayoutParams.WRAP_CONTENT, 1));
        addView(tr);
