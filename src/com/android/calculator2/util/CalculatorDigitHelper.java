...
public final class CalculatorDigitHelper {
    ...
    private static final DecimalFormatSymbols getDecimalFormatForCurrentLocale(Context context) {
    ...
    public static final void getTextForDigits(Context context, DigitHelperCallback callback) {
