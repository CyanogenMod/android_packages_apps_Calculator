...
public final class DigitLabelHelper {
    ...
    private DecimalFormatSymbols getDecimalFormatForCurrentLocale(Context context) {
        ...
        DecimalFormatSymbols decimalFormatSymbols = mDecFormatSymbols;
        if (locale.hashCode() != mLastLocaleHash) {
            ...
            mLastLocaleHash = locale.hashCode();
            decimalFormatSymbols = DecimalFormatSymbols.getInstance(locale);
            mDecFormatSymbols = decimalFormatSymbols;
        }
