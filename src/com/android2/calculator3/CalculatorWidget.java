...
public class CalculatorWidget extends AppWidgetProvider {
    ...
    private void setOnClickListeners(Context context, RemoteViews remoteViews) {
        ...
        intent.setAction("0");
        remoteViews.setOnClickPendingIntent(R.id.digit0, PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT));

        intent.setAction("1");
        remoteViews.setOnClickPendingIntent(R.id.digit1, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("2");
        remoteViews.setOnClickPendingIntent(R.id.digit2, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("3");
        remoteViews.setOnClickPendingIntent(R.id.digit3, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("4");
        remoteViews.setOnClickPendingIntent(R.id.digit4, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("5");
        remoteViews.setOnClickPendingIntent(R.id.digit5, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("6");
        remoteViews.setOnClickPendingIntent(R.id.digit6, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("7");
        remoteViews.setOnClickPendingIntent(R.id.digit7, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("8");
        remoteViews.setOnClickPendingIntent(R.id.digit8, PendingIntent.getBroadcast(context, 0, intent, 0));

        intent.setAction("9");
        remoteViews.setOnClickPendingIntent(R.id.digit9, PendingIntent.getBroadcast(context, 0, intent, 0));
        ...
        remoteViews.setOnClickPendingIntent(R.id.clear, PendingIntent.getBroadcast(context, 0, intent, 0));
    }
}
