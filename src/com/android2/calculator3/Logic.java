...
public class Logic {
    ...
    String localize(String input) {
        ...
        input = input.replace(Pattern.quote(mArcsinString), "asin");
        input = input.replace(Pattern.quote(mArccosString), "acos");
        input = input.replace(Pattern.quote(mArctanString), "atan");
